...
import { deactivateCreatorRedemptionOnRelationshipEnd } from "@/modules/redemption/relationship-end.service";
...
export async function deactivateCreatorConfigsOnRelationshipEnd(
  ...
  await deactivateCreatorRedemptionOnRelationshipEnd(tx, input);
}
