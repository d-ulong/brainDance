...
| R9 | 编辑 **effectiveEndDate + updatedPlan** 为 cancel/horizon/generate 唯一输入；`horizonThrough` 读 `end_date` | `design.md` §5.2、§5.8A；`implement.md` §4.2.5 | F22：`plan-end-date.test.ts` + `formal-plan.test.ts` + `horizon-through.test.ts` |
